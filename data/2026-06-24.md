...
- [机器学习与数据科学](#机器学习与数据科学) [Total: 10]
- [优化控制与系统工程](#优化控制与系统工程) [Total: 18]
- [概率论与随机过程](#概率论与随机过程) [Total: 21]
- [动力系统与微分方程](#动力系统与微分方程) [Total: 10]
...
### [1] [Towards instance-wise calibration: local amortized diagnostics and reshaping of conditional densities (LADaR)](https://arxiv.org/abs/2205.14568v8)
...
### [3] [An information theoretic limit to data amplification](https://arxiv.org/abs/2412.18041v1)
*S J Watts,L Crow*
...
### [4] [Constrained Variable Projection for Structured Problems](https://arxiv.org/abs/2606.23939)
...
### [5] [Wasserstein normalized autoencoder for anomaly detection](https://doi.org/10.1088/2632-2153/ae6168)
...
免费全文: [DOAJ fulltext](https://doi.org/10.1088/2632-2153/ae6168), [Google Scholar search](https://scholar.google.com/scholar?q=Wasserstein+normalized+autoencoder+for+anomaly+detection+10.1088%2F2632-2153%2Fae6168+free+full+text+pdf)
...
### [6] [Leveraging support vector regression, radiomics and dosiomics for outcome prediction in personalized ultra-fractionated stereotactic adaptive radiotherapy (PULSAR)](https://doi.org/10.1088/2632-2153/ae4441)
...
### [7] [Magnetohydrodynamics with physics informed neural operators](https://doi.org/10.1088/2632-2153/ace30a)
...
免费全文: [DOAJ fulltext](https://doi.org/10.1088/2632-2153/ace30a), [Google Scholar search](https://scholar.google.com/scholar?q=Magnetohydrodynamics+with+physics+informed+neural+operators+10.1088%2F2632-2153%2Face30a+free+full+text+pdf)
...
### [9] [Deep numerical schemes for systems of Ergodic BSDEs with applications to regime-switching forward utilities](https://arxiv.org/abs/2606.24271)
...
### [10] [Dirac-Frenkel dynamics with inertia for nonlinearly parametrized solutions of evolution problems](https://arxiv.org/abs/2606.24769)
...
### [11] [Hessian-augmented Supervised Learning for Hamilton-Jacobi-Bellman PDEs](https://arxiv.org/abs/2606.23827)
...
### [12] [Distributionally Robust Joint Information and Mechanism Design for Multi-Area Power System Coordination](https://arxiv.org/abs/2606.24015)
*Furkan Sezer*
...
### [13] [Computational Framework for Bézier Distributions](https://arxiv.org/abs/2606.23841)
...
### [14] [Trade-off invariance for weighted scalarizations in multi-objective optimization](https://arxiv.org/abs/2606.24493)
...
### [17] [Traveling profiles and control cost for a PDE describing the evolution of invasive species](https://arxiv.org/abs/2606.23979)
...
### [18] [Extreme-Case Distorted Utility under Moment Ambiguity](https://arxiv.org/abs/2606.24294)
...
### [19] [A multi-objective perspective on block-structured integer programs with one soft coupling constraint](https://arxiv.org/abs/2606.24318)
...
### [20] [Line Planning at Scale: Models, Methods and Insights](https://arxiv.org/abs/2606.24386)
...
### [21] [Variational convexity: new characterizations, calculus rules, and applications](https://arxiv.org/abs/2606.24545)
...
### [22] [Decomposition-Based Constructive Heuristics for the Linear Ordering Problem](https://arxiv.org/abs/2606.24558)
...
### [23] [Bridging Identification and Second-Order Acceleration: A Fast Alternating Minimization Framework for Composite Optimization](https://arxiv.org/abs/2606.24600)
*Zihao Xia,Min Tao*
...
### [24] [Parallel Dynamic Programming for Conic Linear Quadratic Control](https://arxiv.org/abs/2606.24632)
...
免费全文: [arXiv abstract](https://arxiv.org/abs/2606.24632), [arXiv pdf](https://arxiv.org/pdf/2606.24632), [Google Scholar search](https://scholar.google.com/scholar?q=Parallel+Dynamic+Programming+for+Conic+Linear+Quadratic+Control++free+full+text+pdf)
...
### [26] [Observer design for Lur'e systems via injection of a reconstructed nonlinear output](https://arxiv.org/abs/2606.24656)
*Adel Malik Annabi*
...
### [27] [New Bounds for the Last Iterate of the Stochastic subGradient Method](https://arxiv.org/abs/2606.24879)
...
### [28] [A new perspective in linear Cauchy Elasticity: variational minimum principles for statics, dynamics, and heterogeneous materials](https://arxiv.org/abs/2606.24782)
*Amit Acharya*
...
### [29] [Uniform-in-time Gaussian fluctuations for multiscale nonlinear stochastic systems via Malliavin Calculus](https://arxiv.org/abs/2606.23865)
*Shivam Singh Dhama*
...
### [30] [The one-point Schreier Poisson boundary of Thompson's group $F$](https://arxiv.org/abs/2606.23896)
*Christian Mönch*
...
### [31] [Decorated stable $p$-adic self-similar processes with stationary increments](https://arxiv.org/abs/2606.24056)
...
### [32] [Sparsity-adaptive concentration inequalities for random polynomials](https://arxiv.org/abs/2606.24090)
...
### [33] [Restoring the Fluctuation–Dissipation Theorem in Kardar–Parisi–Zhang Universality Class through a New Emergent Fractal Dimension](https://arxiv.org/abs/2402.15576v1)
...
### [34] [Applicability of the Analytical Solution to N-Person Social Dilemma Games](https://www.frontiersin.org/article/10.3389/fams.2018.00015/full)
...
### [35] [On the stability of rarefaction for stochastic viscous conservation law](https://arxiv.org/abs/2606.24167)
...
### [36] [Corrigendum: Algebraic and toroidal representation of the genetic code](https://www.frontiersin.org/articles/10.3389/fams.2024.1445187/full)
...
### [37] [Task Graph Generation for Heterogeneous UAV Swarms in Partially Observable Adversarial Environments](https://doi.org/10.3390/e28060708)
...
### [38] [Diagonal Frog: High-order positivity-preserving FD schemes for anisotropic Fokker-Planck equations](https://arxiv.org/abs/2606.23980)
*Andrey Itkin*
...
### [39] [Discrimination of Non-Local Correlations](https://www.mdpi.com/1099-4300/21/2/104)
...
### [40] [Emergence of chaotic resonance controlled by extremely weak feedback signals in neural systems](https://www.frontiersin.org/articles/10.3389/fams.2024.1434119/full)
...
### [41] [Dual-Channel Voice Communication System Based on One-Way Quantum Secure Direct Communication—Classical Optical Communication Hybrid Mode](https://doi.org/10.3390/e28060707)
...
### [42] [Directed Brain Network Analysis for Fatigue Driving Based on EEG Source Signals](https://www.mdpi.com/1099-4300/24/8/1093)
...
### [43] [Modeling approaches for assessing device-based measures of energy expenditure in school-based studies of body weight status](https://www.frontiersin.org/articles/10.3389/fams.2024.1399426/full)
...
### [44] [Forward-Secure Linearly Homomorphic Signature Scheme in the Standard Model and Its Application](https://doi.org/10.3390/e28060706)
*Linlin Wang,Zuling Chang*
...
DOI: 10.3390/e28060706

免费全文: [Publisher doi](https://doi.org/10.3390/e28060706), [Google Scholar search](https://scholar.google.com/scholar?q=Forward-Secure+Linearly+Homomorphic+Signature+Scheme+in+the+Standard+Model+and+Its+Application+10.3390%2Fe28060706+free+full+text+pdf)
...
### [46] [Energy, Exergy, Exergoeconomic and Exergoenvironmental Impact Analyses and Optimization of Various Geothermal Power Cycle Configurations](https://www.mdpi.com/1099-4300/23/11/1483)
...
### [47] [Seven Recommendations to Make Your Invasive Alien Species Data More Useful](http://journal.frontiersin.org/article/10.3389/fams.2017.00013/full)
...
### [48] [Toward a Tripartite Taxonomy of Entropy in Physics](https://doi.org/10.3390/e28060704)
*Antoine Druilhe*
...
DOI: 10.3390/e28060704

免费全文: [Publisher doi](https://doi.org/10.3390/e28060704), [Google Scholar search](https://scholar.google.com/scholar?q=Toward+a+Tripartite+Taxonomy+of+Entropy+in+Physics+10.3390%2Fe28060704+free+full+text+pdf)
...
DOI: 10.3390/e28060705

免费全文: [Publisher doi](https://doi.org/10.3390/e28060705), [Google Scholar search](https://scholar.google.com/scholar?q=Geodesic+Execution+Slippage%3A+A+Statistical+Physics+Framework+for+Cryptocurrency+Liquidity+Risk+10.3390%2Fe28060705+free+full+text+pdf)
...
### [50] [On the geometry of unbounded wandering domains](https://arxiv.org/abs/2606.23842)
*Beno Učakar*
...
### [51] [Delay-Penalty Comparison for Sequential Testing and Quickest Detection in State-Dependent Diffusion Models](https://arxiv.org/abs/2606.23962)
*Ye Liang*
...
### [52] [Reinforcement learning with learned gadgets to tackle hard quantum problems on real hardware](https://arxiv.org/abs/2411.00230v3)
...
### [53] [A periodic flow with high emergence](https://arxiv.org/abs/2606.23844)
*Odylo Costa*
...
### [54] [Monge-Ampère-type equation for forms of positive degree and Demailly's transcendental Morse inequality](https://arxiv.org/abs/2606.23981)
*Mathew George*
...
### [55] [Non-volatile chirality switching by all-optical magnetization reversal in ferromagnetic Weyl semimetal Co3Sn2S2](https://doi.org/10.1038/s42005-022-01106-8)
...
### [56] [Multiplexed quantum repeaters based on single-photon interference with mild stabilization](https://doi.org/10.1038/s42005-024-01849-6)
...
免费全文: [DOAJ fulltext](https://doi.org/10.1038/s42005-024-01849-6), [Google Scholar search](https://scholar.google.com/scholar?q=Multiplexed+quantum+repeaters+based+on+single-photon+interference+with+mild+stabilization+10.1038%2Fs42005-024-01849-6+free+full+text+pdf)
...
### [57] [Efficient off-chip configuration method for scalable programmable photonic integrated circuits](https://doi.org/10.1038/s42005-025-02135-9)
...
### [58] [Author Correction: Synchronization in networked systems with large parameter heterogeneity](https://doi.org/10.1038/s42005-023-01401-y)
...
### [59] [Flexible and Stable Dynamics Discovery with Onsager's Variational Principle](https://arxiv.org/abs/2606.24106)
...
### [60] [Exact vs approximate second-order derivatives in vertically-integrated ice sheet models](https://arxiv.org/abs/2606.23691)
...
### [61] [Ten Digits on a Train: AI-Assisted Verification of Two Eigenvalue Problems](https://arxiv.org/abs/2606.23821)
*Matthew J. Colbrook*
...
### [62] [Computing the minimal monomial basis for multivariate Birkhoff interpolation](https://arxiv.org/abs/2606.24054)
...
### [63] [E Scheme and Flux-Limiter Scheme, Revisited](https://arxiv.org/abs/2606.24186)
*Huazhong Tang*
...
### [64] [Dynamical low-rank methods for the Wigner equation I: separable difference potential](https://arxiv.org/abs/2606.24190)
...
### [65] [Tractability versus curse of dimensionality for geometric $L_p$-discrepancies](https://arxiv.org/abs/2606.24195)
...
### [66] [Quasi-Monte Carlo for SDE Simulation: Error Analysis and Dimensionality Reduction](https://arxiv.org/abs/2606.24207)
...
### [67] [The 3D Nonconforming Virtual Element Method with enhanced spaces: numerical investigation and implementation guide](https://arxiv.org/abs/2606.24306)
...
### [68] [A sparse spectral method on a class of domains bounded by planar algebraic curves](https://arxiv.org/abs/2606.24423)
...
### [69] [Randomized Estimation of T-Eigenvalues of T-SPD Tensors: A Two-Sided Bracket](https://arxiv.org/abs/2606.24491)
...
### [70] [Certified Reachable Sets for Nonlinear Reaction--Diffusion Systems](https://arxiv.org/abs/2606.24500)
...
### [71] [Analysis and approximation of a two-dimensional induction heating problem](https://arxiv.org/abs/2606.24517)
...
### [72] [The lymph 2.0 library: p-adaptive algorithms and parallel assembly strategies for polytopal DG methods](https://arxiv.org/abs/2606.24646)
...
### [73] [Recursive expansion of the matrix step function using polynomials of degree eight](https://arxiv.org/abs/2606.24701)
...
### [74] [LAMG+: A Robust Lean Algebraic Multigrid Solver for Graph Laplacians](https://arxiv.org/abs/2606.24791)
*Oren E. Livne*
...
### [75] [Sharp Sobolev Sandwich and Approximation Rates of Radon-Domain $L^p$ Ridge Integral Spaces for ReLU$^k$ Networks](https://arxiv.org/abs/2606.24795)
...
### [76] [The Effect of Quadrature on the Convergence of Policy Iteration for Hamilton-Jacobi-Bellman Equations](https://arxiv.org/abs/2606.24806)
