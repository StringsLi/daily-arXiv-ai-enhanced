...
- [机器学习与数据科学](#机器学习与数据科学) [Total: 6]
- [优化控制与系统工程](#优化控制与系统工程) [Total: 9]
- [概率论与随机过程](#概率论与随机过程) [Total: 10]
- [动力系统与微分方程](#动力系统与微分方程) [Total: 19]
...
一句话结论: Variable projection is a classical technique for separabl.
...
### [2] [Towards instance-wise calibration: local amortized diagnostics and reshaping of conditional densities (LADaR)](https://arxiv.org/abs/2205.14568v8)
...
一句话结论: Motivated by an application in machine learning optimizat.
...
### [5] [Wasserstein normalized autoencoder for anomaly detection](https://arxiv.org/abs/2510.02168v2)
...
一句话结论: A novel anomaly detection algorithm is presented.
...
### [6] [Leveraging support vector regression, radiomics and dosiomics for outcome prediction in personalized ultra-fractionated stereotactic adaptive radiotherapy (PULSAR)](https://arxiv.org/abs/2509.07872v2)
...
一句话结论: The top-performing model achieves an R ^2 of 0.
...
### [7] [Hessian-augmented Supervised Learning for Hamilton-Jacobi-Bellman PDEs](https://arxiv.org/abs/2606.23827)
...
一句话结论: A data-driven method is developed for approximating value.
...
### [8] [Distributionally Robust Joint Information and Mechanism Design for Multi-Area Power System Coordination](https://arxiv.org/abs/2606.24015)
*Furkan Sezer*
...
一句话结论: We study a continuous-time stochastic Stackelberg control.
...
### [9] [Obstacles and Singularities of Riemannian Distance Functions](https://arxiv.org/abs/2606.24397)
...
一句话结论: We study the distance function from a point target in the.
...
### [10] [Computational Framework for Bézier Distributions](https://arxiv.org/abs/2606.23841)
...
一句话结论: Flexible continuous univariate distributions with bounded.
...
### [11] [Trade-off invariance for weighted scalarizations in multi-objective optimization](https://arxiv.org/abs/2606.24493)
...
一句话结论: We consider weighted-sum scalarizations for an abstract m.
...
### [12] [Suboptimal and Reduced-Order MPC via Timescale Separation](https://arxiv.org/abs/2606.24641)
...
### [13] [A Lorentzian Lasry-Lions regularization theorem](https://arxiv.org/abs/2606.23976)
*Alec Metsch*
...
一句话结论: The main goal of this paper is to establish a general Lor.
...
### [14] [Quantum Control Design by Lyapunov Trajectory Tracking and Optimal Control](https://www.mdpi.com/1099-4300/26/11/978)
...
一句话结论: In this paper, we investigate a Lyapunov trajectory track.
...
### [15] [Traveling profiles and control cost for a PDE describing the evolution of invasive species](https://arxiv.org/abs/2606.23979)
...
### [16] [Uniform-in-time Gaussian fluctuations for multiscale nonlinear stochastic systems via Malliavin Calculus](https://arxiv.org/abs/2606.23865)
*Shivam Singh Dhama*
...
一句话结论: We establish a uniform-in-time quantitative central limit.
...
### [17] [The one-point Schreier Poisson boundary of Thompson's group $F$](https://arxiv.org/abs/2606.23896)
*Christian Mönch*
...
### [18] [Decorated stable $p$-adic self-similar processes with stationary increments](https://arxiv.org/abs/2606.24056)
...
一句话结论: We construct new classes of examples of self-similar proc.
...
一句话结论: The Kardar–Parisi–Zhang (KPZ) equation describes a wide r.
...
### [20] [Diagonal Frog: High-order positivity-preserving FD schemes for anisotropic Fokker-Planck equations](https://arxiv.org/abs/2606.23980)
*Andrey Itkin*
...
### [21] [Sparsity-adaptive concentration inequalities for random polynomials](https://arxiv.org/abs/2606.24090)
...
一句话结论: In degree two, it recovers sparse Hanson-Wright bounds.
...
### [22] [Discrimination of Non-Local Correlations](https://www.mdpi.com/1099-4300/21/2/104)
...
一句话结论: The first bound is linear in the number of measurements.
...
### [23] [On the stability of rarefaction for stochastic viscous conservation law](https://arxiv.org/abs/2606.24167)
...
一句话结论: We study the asymptotic stability of rarefaction waves fo.
...
### [24] [Directed Brain Network Analysis for Fatigue Driving Based on EEG Source Signals](https://www.mdpi.com/1099-4300/24/8/1093)
...
一句话结论: Fatigue driving is one of the major factors that leads to.
...
### [25] [Applicability of the Analytical Solution to N-Person Social Dilemma Games](https://www.frontiersin.org/article/10.3389/fams.2018.00015/full)
...
一句话结论: The purpose of this study is to present an analysis of th.
...
### [26] [Delay-Penalty Comparison for Sequential Testing and Quickest Detection in State-Dependent Diffusion Models](https://arxiv.org/abs/2606.23962)
*Ye Liang*
...
一句话结论: We study sequential testing and Bayesian quickest detecti.
...
### [27] [Monge-Ampère-type equation for forms of positive degree and Demailly's transcendental Morse inequality](https://arxiv.org/abs/2606.23981)
*Mathew George*
...
一句话结论: The Monge-Ampère-type equation for forms of positive degr.
...
### [28] [Vekua-Type Operators on Compact Lie Groups: Hypoellipticity, Solvability, and Self-Duality](https://arxiv.org/abs/2606.24053)
...
一句话结论: We study global hypoellipticity and global solvability fo.
...
### [29] [Regularity for Minimizers of non Autonomous Singular Functionals with Anisotropic Growth](https://arxiv.org/abs/2606.24293)
...
一句话结论: We establish the higher differentiability of the local mi.
...
### [30] [On the geometry of unbounded wandering domains](https://arxiv.org/abs/2606.23842)
*Beno Učakar*
...
一句话结论: We study the geometry of unbounded wandering domains of e.
...
### [31] [A periodic flow with high emergence](https://arxiv.org/abs/2606.23844)
*Odylo Costa*
...
一句话结论: We construct a smooth nonsingular periodic flow on a comp.
...
### [32] [Asymptotics of Soliton Gas for the Derivative Nonlinear Schrodinger Equation](https://arxiv.org/abs/2606.24435)
...
一句话结论: For admissible domains, e.
...
### [33] [Flexible and Stable Dynamics Discovery with Onsager's Variational Principle](https://arxiv.org/abs/2606.24106)
...
一句话结论: Variational principles specify the dynamics of a physical.
...
### [34] [Reinforcement learning with learned gadgets to tackle hard quantum problems on real hardware](https://arxiv.org/abs/2411.00230v3)
...
一句话结论: Abstract Quantum computing offers exciting opportunities.
...
### [35] [Well-posedness of the weakly singular Burton-Miller equation for Helmholtz transmission problems](https://arxiv.org/abs/2606.24492)
*Yasuhiro Matsumoto*
...
一句话结论: Although various boundary integral formulations are avail.
...
### [36] [When Entropy flows: drifting along the route to Chaos](https://arxiv.org/abs/2606.24289)
...
### [37] [Non-volatile chirality switching by all-optical magnetization reversal in ferromagnetic Weyl semimetal Co3Sn2S2](https://doi.org/10.1038/s42005-022-01106-8)
...
一句话结论: Weyl semimetals exhibit a unique feature known as Weyl no.
...
### [38] [Nonexistence of finite-time blow-up for the equivariant harmonic map heat flow from $B^2$ to $S^2$](https://arxiv.org/abs/2606.24555)
*Dylan Samuelian*
...
一句话结论: We consider $D$-equivariant solutions to the harmonic map.
...
### [39] [Rigidity of McMullen Julia sets](https://arxiv.org/abs/2606.24520)
...
一句话结论: We provide a complete quasisymmetric classification of th.
...
### [40] [Multiplexed quantum repeaters based on single-photon interference with mild stabilization](https://arxiv.org/abs/2401.09578v2)
...
一句话结论: Abstract Quantum repeaters are pivotal in the physical la.
...
### [41] [An integral formula for the inhomogeneous Jordan--von Neumann equation](https://arxiv.org/abs/2606.24565)
...
一句话结论: We study the inhomogeneous form of the Jordan--von Neuman.
...
### [42] [Bialgebraic geometry of Böttcher coordinates](https://arxiv.org/abs/2606.24553)
*Sina Saleh*
...
一句话结论: Becker and Bergweiler showed that if $f$ is a non-excepti.
...
### [43] [Efficient off-chip configuration method for scalable programmable photonic integrated circuits](https://doi.org/10.1038/s42005-025-02135-9)
...
### [44] [Geometric approaches for improved regularity in fully nonlinear parabolic models](https://arxiv.org/abs/2606.24617)
...
一句话结论: $$ Our analysis reveals two distinct regimes.
...
一句话结论: However, many of our most widely-used models are not.
...
一句话结论: Accurate numerical eigenvalues are often difficult to cer.
...
### [48] [Computing the minimal monomial basis for multivariate Birkhoff interpolation](https://arxiv.org/abs/2606.24054)
...
一句话结论: This paper studies algorithms for computing the minimal m.
...
### [49] [E Scheme and Flux-Limiter Scheme, Revisited](https://arxiv.org/abs/2606.24186)
*Huazhong Tang*
...
一句话结论: It may not be second-order accurate in both space and time.
